        ...
        <footer className="p-6 dark:bg-coolGray-800 dark:text-coolGray-100 divide-y divide-gray-400 divide-opacity-70 divide-solid bg-gray-700 text-white">
            <div className="container grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-5 ">
                <div className="flex flex-col space-y-4 ">
                    <h2 className="font-medium">TIX</h2>
            ...
            <div className="grid justify-center pt-6 lg:justify-between">
                ...
                <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
                    <a href="https://tix.vn/" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-violet-400 dark:text-coolGray-900">
